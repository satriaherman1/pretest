...
function DashboardCard({ title, total, bottomText, bottomTextColor, bottomIcon }: IDashboardCardProps) {
  ...
  return (
    <Box padding="16px" borderRadius="20px" minW="240px" boxShadow={boxShadow}>
      ...
      <Text fontSize="14px" as="small" color={bottomTextColor} marginTop={4} textAlign="right" display="flex" gap="4px" justifyContent="flex-end" alignItems="center" fontWeight="bold">
